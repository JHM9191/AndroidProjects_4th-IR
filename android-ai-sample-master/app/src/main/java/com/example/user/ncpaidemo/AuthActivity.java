...
public class AuthActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String applicationClientId = sharedPref1.getString("application_client_id", "hxogc4kfmn");
        String applicationClientSecret = sharedPref1.getString("application_client_secret", "N4W4TC1b7w92mLPRuJQh4vrqKrVG7zEu1skcBUcQ");

        String chatbotApiGwUrl = sharedPref1.getString("chatbot_api_gw_url", "https://chatbot.ncloud.com/api/chatbot/messenger/v1/2355/21ef1c76926680c46f8864ec6a53345518bc3bbb33a1d0f262db1a1330a89949");
        String chatbotSecretKey = sharedPref1.getString("chatbot_secret_key", "Q3ptVkRGVVBYUm5NUW1kWnB6Wmd5V1l3bUp3SUZSTVE=");
